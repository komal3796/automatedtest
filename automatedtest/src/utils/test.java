...
@Test(dataProvider="test2data")
	...
	public static void test2(String Account,String Password, String Lastname,String Postcode,String Email,String Phone,String Frequency,String Day,String Sortcode,String Bankacnt) throws IOException, InterruptedException {
   ...
   WebDriverWait wait = new WebDriverWait(driver,10);
	...
	driver.findElement(By.id("btnNext")).click();
	 ...
	 driver.findElement(By.id("password")).sendKeys(Password) ;
			 ...
			 driver.manage().timeouts().implicitlyWait(10,TimeUnit.SECONDS);
			 driver.findElement(By.xpath("(//a[@class=\"btn btn-tw-primary ui-text-anclink-viewact\"])[7]")).click();
			 driver.manage().timeouts().implicitlyWait(10,TimeUnit.SECONDS);
...
driver.findElement(By.xpath("//span[text()='Sort code']/../following-sibling::div/input")).sendKeys(Sortcode);
		  ...
		  //next button
		    ...
		    //verify payment details on summary screen
		    WebElement payment = driver.findElement(By.xpath("//section[@id=\"newPaymentsInfoSummary\"]"));
		    wait.until(ExpectedConditions.visibilityOf(payment));
		   String pay = payment.getText();
	        String expected = "Your payment details:";
	        String pay1 = driver.findElement(By.xpath("//section[@id=\"newPaymentsInfoSummary\"]/div/div/div/div[1]")).getText();	
        	String pay2 = driver.findElement(By.xpath("//section[@id=\"newPaymentsInfoSummary\"]/div/div/div/div[2]")).getText();	
		   // check visibility with isDisplayed()
	        if (pay==expected){
	        ...
	        System.out.println("Payment details not displayed");
	        } 
	        */
	        JavascriptExecutor js5 = (JavascriptExecutor) driver;
...
public  Object[][] testdata2(String excelpath, String sheetname)
{
	excelutils excel = new excelutils(excelpath,sheetname);
	int rowcount= excel.getRowCount();
	int colcount = excel.getColCount();
